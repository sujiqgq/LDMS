...
procedure TfrmLD5Q041.QuickRepNeedData(Sender: TObject;
...
procedure TfrmLD5Q041.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   inherited;

   if frmLD5Q04.RBtn_Bunju.Checked then QRLabel5.Caption := '분주일자 : '
   ...
   UV_iCount := 1;
   if ((frmLD5Q04.grdMaster.Rows mod 100) = 0) then
      sRec := Round(frmLD5Q04.grdMaster.Rows div 100)
   else
   begin
      sRec := Round(frmLD5Q04.grdMaster.Rows div 100) + 1;
   end;
   cRow := 0; iRow := 0; 
end;
