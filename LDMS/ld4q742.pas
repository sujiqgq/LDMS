...
procedure TfrmLD4Q742.QuickRepNeedData(Sender: TObject;
...
procedure TfrmLD4Q742.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   inherited;

   if frmLD4Q74.Chk_bunju.checked then
   begin
        QRLabel5.Caption := '분주일자 :';
        Qrl_Date.Caption := copy(frmLD4Q74.edtBDate.Text,1,4) + '년'  +
                            copy(frmLD4Q74.edtBDate.Text,5,2) + '월'  +
                            copy(frmLD4Q74.edtBDate.Text,7,2) + '일';
   end
   else
   begin
