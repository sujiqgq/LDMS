...
type
  TfrmLD8Q071 = class(TfrmPrintForm)
    TitleBand1: TQRBand;
    QRLabel1: TQRLabel;
    QRLabel2: TQRLabel;
    QRLabel4: TQRLabel;
...
var
  frmLD8Q071: TfrmLD8Q071;

implementation

uses ZZFunc, ZZComm, MdmsFunc, LD8Q07;

{$R *.DFM}


procedure TfrmLD8Q071.QuickRepNeedData(Sender: TObject;
  var MoreData: Boolean);
begin
   inherited;
   with frmLD8Q07.grdMaster do
   begin
      // 자료가 없을경우의 처리
      if Rows = 0 then
      begin
...
procedure TfrmLD8Q071.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
Var
...
begin
   ...
   // 조회조건을 전달
   QRL_STDATE.Caption   := Copy(frmLD8Q07.mskST_date.Text,1,4) + '/' +
                           Copy(frmLD8Q07.mskST_date.Text,5,2) + '/' +
                           Copy(frmLD8Q07.mskST_date.Text,7,2);
   QRL_EDDATE.Caption   := Copy(frmLD8Q07.mskED_date.Text,1,4) + '/' +
                           Copy(frmLD8Q07.mskED_date.Text,5,2) + '/' +
                           Copy(frmLD8Q07.mskED_date.Text,7,2);
