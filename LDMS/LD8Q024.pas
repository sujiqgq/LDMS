...
var
  frmLD8Q024: TfrmLD8Q024;

implementation

uses ZZFunc, ZZMenu, ZZComm, MdmsFunc, LD8Q02, LD8Q022, LD8Q023;

{$R *.DFM}

procedure TfrmLD8Q024.QuickRepNeedData(Sender: TObject;
...
procedure TfrmLD8Q024.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
var
   i : integer;
begin
   ...
   begin
      if (trim(frmLD8Q02.grdMaster.Cell[1,i]) = 'S001') then
      begin
         UV_iSpace := i;
