...
type
  ...
  private
    ...
    UV_vNo,UV_vNum_samp, UV_vName, UV_vS021,UV_vS018,UV_vS019,UV_vC044,UV_vBUN : Variant;
...
var
  frmLD4Q51: TfrmLD4Q51;

implementation

uses ZZFunc, ZZMenu, ZZComm, MdmsFunc, LD4Q511;

{$R *.DFM}

procedure TfrmLD4Q51.UP_KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmLD4Q51.MouseWheelHandler(var Message: TMessage);  //수정
begin
...
procedure TfrmLD4Q51.UP_VarMemSet(iLength : Integer);
begin
...
function TfrmLD4Q51.UF_Condition : Boolean;
begin
   Result := True;
...
procedure TfrmLD4Q51.FormCreate(Sender: TObject);
begin
   inherited;
   UP_VarMemSet(0);
...
procedure TfrmLD4Q51.grdMasterCellLoaded(Sender: TObject; DataCol,
  DataRow: Integer; var Value: Variant);
begin
   inherited;
   ...
   case DataCol of
      ...
      5 : Value := UV_vS021[DataRow-1];
   end;
end;

procedure TfrmLD4Q51.btnQueryClick(Sender: TObject);
...
begin
   ...
   begin
      ...
      sSelect := ' SELECT  D.Desc_dc, B.desc_rackno,B.num_Bunju, G.num_jumin, G.num_samp,G.desc_name, G.num_id, G.dat_gmgn, G.cod_jisa, G.gubn_nosin, G.gubn_adult, G.gubn_life, G.Gubn_bogun, G.Gubn_agab, G.Gubn_tkgm,  ' +
      ...
      if RG_01.ItemIndex = 0 then sOrderBy := ' ORDER BY G.num_samp '
      else sOrderBy := ' ORDER BY B.num_bunju ';
      ...
      begin
         GP_query_log(qryBunju, 'LD4Q51', 'Q', 'N');
...
procedure TfrmLD4Q51.UP_Change(Sender: TObject);
var sName : String;
begin
  inherited;
...
procedure TfrmLD4Q51.UP_Click(Sender: TObject);
...
procedure TfrmLD4Q51.btnPrintClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmLD4Q51.FormActivate(Sender: TObject);
begin
   inherited;
   mskFrom.Text := '0001';
   mskTo.Text := '9999';
...
procedure TfrmLD4Q51.QRCompositeReportAddReports(Sender: TObject);
begin
  inherited;
  frmLD4Q511 := TfrmLD4Q511.Create(Self);

  with QRCompositeReport do
  begin
    Reports.Add(frmLD4Q511.QuickRep);
  end;
end;

function TfrmLD4Q51.UF_hangmokList : String;
var
...
function TfrmLD4Q51.UF_No_Hangmok(sDate, sGubun : String; iYh : Integer): String;
begin
   Result := '';
