...
procedure TfrmLD1P121.UP_FieldClear(frm : TWinControl);
var i : Integer;
begin
...
procedure TfrmLD1P121.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
      ...
      begin
         ...
         begin
               ...
               QRL_datgmgn.Caption := copy(qryCell.FieldByName('dat_last').AsString,1,4)+ '-' + copy(qryCell.FieldByName('dat_last').AsString,5,2)+
                                      '-' + copy(qryCell.FieldByName('dat_last').AsString,7,2) + '  ' + (qryCell.FieldByName('dat_time').AsString) ;
               end;
               ...
               qrl_Result.Caption := GF_DateFormat(qryCell.FieldByName('dat_result').AsString) + '  ' + (qryCell.FieldByName('dat_time_R').AsString);
