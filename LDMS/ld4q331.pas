...
procedure TfrmLD4Q331.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   inherited;
...
procedure TfrmLD4Q331.QuickRep1NeedData(Sender: TObject;
  var MoreData: Boolean);
begin
   inherited;

   with frmLD4Q33.grdMaster do
   begin
      // 자료가 없을경우의 처리
      if Rows = 0 then
      begin
