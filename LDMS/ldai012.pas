...
procedure TfrmLDAI012.UP_KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmLDAI012.MouseWheelHandler(var Message: TMessage);  //수정
begin
...
procedure TfrmLDAI012.UP_VarMemSet(iLength : Integer);
begin
...
function TfrmLDAI012.UF_Condition : Boolean;
begin
   Result := True;
end;

procedure TfrmLDAI012.FormCreate(Sender: TObject);
begin
   inherited;
   UP_VarMemSet(0);
end;

procedure TfrmLDAI012.grdMasterCellLoaded(Sender: TObject; DataCol,
  DataRow: Integer; var Value: Variant);
begin
   inherited;
...
procedure TfrmLDAI012.btnQueryClick(Sender: TObject);
...
procedure TfrmLDAI012.SBut_ExcelClick(Sender: TObject);
var
  XL,WorkBook: Variant;
  i : integer;
  ArrV3 : OleVariant;
...
procedure TfrmLDAI012.FormKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
