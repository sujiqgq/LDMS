...
var
  frmLD4Q74: TfrmLD4Q74;

implementation

uses ZZFunc, ZZMenu, ZZComm, MdmsFunc,  LD4Q742;

{$R *.DFM}

procedure TfrmLD4Q74.UP_VarMemSet(iLength : Integer);
begin
...
function TfrmLD4Q74.UF_Condition : Boolean;
begin
   Result := True;
...
procedure TfrmLD4Q74.FormCreate(Sender: TObject);
begin
   inherited;
   UP_VarMemSet(0);
...
procedure TfrmLD4Q74.grdMasterCellLoaded(Sender: TObject; DataCol,
  DataRow: Integer; var Value: Variant);
begin
   inherited;
...
procedure TfrmLD4Q74.btnQueryClick(Sender: TObject);
var index, I : Integer;
...
begin
   ...
   begin
      ...
      begin
         GP_query_log(qryBunju, 'LD4Q74', 'Q', 'N');
         ...
         Begin
            ...
            Begin
               ...
               if (pos('Y004',qryGumgin.FieldByName('cod_chuga').AsString) > 0) then
                  sCheck := '99';
...
procedure TfrmLD4Q74.UP_Click(Sender: TObject);
begin
   inherited;
...
procedure TfrmLD4Q74.btnPrintClick(Sender: TObject);
begin
  inherited;

     if RBtn_preveiw.Checked = True then
     begin
        frmLD4Q742 := TfrmLD4Q742.Create(Self);
        frmLD4Q742.QuickRep.Preview;
     end
     else
     begin
        frmLD4Q742 := TfrmLD4Q742.Create(Self);
        frmLD4Q742.QuickRep.Print;
     end;

end;

Procedure TfrmLD4Q74.Hangmok_Set;
Var I, J, K : Integer;
Begin
      Inherited;
//PRofile Reading
...
procedure TfrmLD4Q74.Ck_NewClick(Sender: TObject);
begin
  inherited;
