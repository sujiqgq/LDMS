...
procedure TfrmLD1P122.UP_FieldClear(frm : TWinControl);
var i : Integer;
begin
...
procedure TfrmLD1P122.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
...
begin
   ...
   begin
      ...
      begin
         QRL_datgmgn.Caption  := copy(frmLD1P12.Date_gmgn.Text,4,1);
         QRL_datgmgn2.Caption := copy(frmLD1P12.Date_gmgn.Text,5,2);
         QRL_datgmgn3.Caption := copy(frmLD1P12.Date_gmgn.Text,7,2);
      end
      else
         QRL_datgmgn.Caption := '';  }
