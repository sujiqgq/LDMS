...
procedure TfrmLD2I05.UP_Click(Sender: TObject);
...
procedure TfrmLD2I05.FormCreate(Sender: TObject);
begin
   inherited;
...
procedure TfrmLD2I05.btnStartClick(Sender: TObject);
...
//            sWhere := sWhere + ' AND cod_dc = ''' + edtDC.text + '''';
            sWhere := sWhere + ' AND (((cod_jangbi = ''CV01'' or cod_jangbi = ''CV04'') AND cod_hul = '''' AND cod_chuga = '''') or ';     //
            sWhere := sWhere + '      (cod_dc = ''156940'' or cod_dc = ''156944'' or cod_dc = ''153418'')) ';
...
//            sWhere := sWhere + ' AND num_id = ''1502047575''';
         ...
         begin
            GP_query_log(qryGumgin, 'LD2I05', 'Q', 'N');
            // Animate Start
              ...
              { if Trim(FieldByName('cod_jangbi').AsString) <> '' then
               ...
               begin
                  ...
                  begin
                     ...
                     qryI_Bunju.ExecSQL;
                     GP_query_log(qryI_Bunju, 'LD2I05', 'Q', 'Y');
                 end;
               end
               //장비번호 축출
                     ...
                     begin
                        ...
                        06 : begin
                                ...
                                begin
                                   ...
                                   qryI_Cell.ExecSQL;
                                   GP_query_log(qryI_Cell, 'LD2I05', 'Q', 'Y');
                                   // Table disconnect
                                   qrySeq.Active := False;
                                end;
                                qry_cell.Active := False;
                        ...
                        begin
                           qryI_Gulkwa.ExecSQL;
                           GP_query_log(qryI_Gulkwa, 'LD2I05', 'Q', 'Y');
                        end;
                     end;
                     qryProfileG.Next;
                  end;
...
{               else if FieldByName('gubn_gong').AsString = '2' then
               ...
               qryU_Gumgin.ExecSQL;
               GP_query_log(qryU_Gumgin, 'LD2I05', 'Q', 'Y');
               ...
               begin
                  ...
                  GP_query_log(qryIHgulkwa_chk, 'LD2I05', 'Q', 'Y');
               end;
...
procedure TfrmLD2I05.UP_KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
   inherited;
...
function  TfrmLD2I05.UF_BunjuNo(iBunjuNo, iBunjuNoe : Integer) : Integer;
begin
   Result := iBunjuNo;
...
function  TfrmLD2I05.UF_No_Hangmok(sDate, sGubun : String; iYh : Integer): String;
begin
   Result := '';
...
function  TfrmLD2I05.UF_Jae_Hangmok(sJisa, sJumin, sGubun : String; iYh : Integer): String;
begin
   Result := '';
   with qryJaegumhm do
   begin
...
procedure TfrmLD2I05.UP_Change(Sender: TObject);
var sName : String;
begin
  inherited;
