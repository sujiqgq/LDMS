...
procedure TfrmLD5Q052.QuickRepNeedData(Sender: TObject;
...
procedure TfrmLD5Q052.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   UV_iCount := 0;
end;
