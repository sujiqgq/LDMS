...
procedure TfrmLD5Q082.QuickRepNeedData(Sender: TObject;
...
procedure TfrmLD5Q082.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   UV_iCount := 0;
end;
