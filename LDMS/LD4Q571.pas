...
var
  frmLD4Q571: TfrmLD4Q571;

implementation

uses ZZFunc, ZZMenu, ZZComm, MdmsFunc,LD4Q57;

{$R *.DFM}

procedure TfrmLD4Q571.QuickRepNeedData(Sender: TObject; var MoreData: Boolean);
  var temp,tempa :String;
  begin

   inherited;

   with frmLD4Q57.grdMaster do
   begin
...
procedure TfrmLD4Q571.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   inherited;
   QRL_date.Caption := copy(frmLD4Q57.EdtBDate.Text,1,4) + '년'  +
                       copy(frmLD4Q57.EdtBDate.Text,5,2) + '월'  +
                       copy(frmLD4Q57.EdtBDate.Text,7,2) + '일';
   UV_iCount := 0;
end;
