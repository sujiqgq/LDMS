...
type
  TfrmLD4I03 = class(TfrmSingle)
    ...
    procedure grdMasterButtonClick(Sender: TObject; DataCol,
      DataRow: Integer);
...
uses ZZFunc, ZZMenu, ZZComm, MdmsFunc,LD4I031;
...
procedure TfrmLD4I03.grdMasterCellLoaded(Sender: TObject; DataCol,
  DataRow: Integer; var Value: Variant);
  var sSelect,sWhere,sOrder  :String;
begin
   inherited;
  case DataCol of
      ...
      3: begin
         qry_CK_PPBS.Filter := ' num_id = '''+UV_vnum_id[DataRow-1]+''' and dat_gmgn < ''' + UV_vDat_gmgn[DataRow-1] + ''' ';  
              if qry_CK_PPBS.IsEmpty = False then
              begin
              ...
              begin
                 grdMaster.CellReadOnly[DataCol, DataRow] := roOn;
                 value      := UV_vdesc_name[DataRow-1];
              end;
       end;
      end;
...
procedure TfrmLD4I03.grdMasterRowChanged(Sender: TObject; OldRow,
  NewRow: Integer);
var sMan,sSelect,sWhere,sOrder : String;
    iAge : integer;
begin
   inherited;
   UV_vstatus := false;
...
procedure TfrmLD4I03.grdMasterButtonClick(Sender: TObject; DataCol,
  DataRow: Integer);
  var sSelect, sWhere, sOrder : String;
begin
  inherited;
      frmLD4I031 := TfrmLD4I031.Create(Self);
      frmLD4I031.Edt_Num_jumin.Text     := UV_vNum_jumin[DataRow-1];
      frmLD4I031.Edt_desc_name.Text  := UV_vDesc_name[DataRow-1];
      frmLD4I031.Edt_cod_jisa.Text   := UV_vCod_jisa[DataRow-1];

       with qryPBS_count do
       begin
         Active := False;
         sSelect := 'SELECT *  FROM PBSmear ';
         sWhere := ' WHERE ' + sWhere + ' num_id = ''' + UV_vNum_id[DataRow-1] + '''';
         sOrder := ' ORDER BY dat_gmgn';
         SQL.Clear;
         SQL.Add(sSelect + sWhere + sOrder);
         Active := True;
         frmLD4I031.cmbGmgn.Clear;
         while not Eof do
               begin
               frmLD4I031.cmbGmgn.Items.Add(qryPBS_count.FieldByname('DAT_GMGN').AsString);
               Next;
            end;
            // 마지막 자료를 Default로 표시
            frmLD4I031.cmbGmgn.ItemIndex := frmLD4I031.cmbGmgn.Items.Count - 1;
      end;
     frmLD4I031.ShowModal
     end;
end.
