...
type
 ...
 private
    ...
    UV_vSP001, UV_vSP002, UV_vSP003, UV_vSP004, UV_vSP005, UV_vSP006, UV_vSP007 : Variant;
...
procedure TfrmLD3I14.FormCreate(Sender: TObject);
begin
   inherited;
...
procedure TfrmLD3I14.UP_SVarMemSet(iLength : Integer);
begin
...
procedure TfrmLD3I14.qrdSListCellLoaded(Sender: TObject; DataCol,
  DataRow: Integer; var Value: Variant);
begin
   inherited;
   case DataCol of
...
procedure TfrmLD3I14.UP_SPVarMemSet(iLength : Integer);
begin
   // Variant Memory Allocation
   if iLength = 0 then
   begin
      ...
      UV_vSP007 := VarArrayCreate([0, 0], varOleStr);
   end
   else
   begin
      ...
      VarArrayRedim(UV_vSP007, iLength);
   end;
end;
procedure TfrmLD3I14.qrdSPListCellLoaded(Sender: TObject; DataCol,
  DataRow: Integer; var Value: Variant);
begin
   inherited;
   case DataCol of
      ...
      7 : Value := UV_vSP007[DataRow - 1];
   end;
end;

procedure TfrmLD3I14.btnDESC_DEPTClick(Sender: TObject);
begin
   inherited;
...
procedure TfrmLD3I14.btnStartClick(Sender: TObject);
var
...
procedure TfrmLD3I14.Btn_InsertClick(Sender: TObject);
var
...
begin
   ...
   begin
      ...
      try
         ...
         begin
              Active := False;
              qryGulkwa.ParamByName('cod_jisa').AsString   := TG_gumgin.Cells[5,I];
              qryGulkwa.ParamByName('cod_bjjs').AsString   := TG_gumgin.Cells[6,I];
              ...
              begin
                ...
                BEGIN
                   ...
                   UV_vS007[sIndex] := TG_gumgin.Cells[6,I];
                   ...
                   qryU_Gulkwa.ParamByName('COD_jisa').AsString     := TG_gumgin.Cells[5,I];
                   qryU_Gulkwa.ParamByName('COD_bjjs').AsString     := TG_gumgin.Cells[6,I];
              ...
              begin
                   ...
                   UV_vSP007[spIndex] := TG_gumgin.Cells[6,I];
                   Inc(spIndex);
              end; // end of else;
         end; // end of with;
         except
...
function TfrmLD3I14.UF_hangmokList : String;
var
...
function TfrmLD3I14.UF_No_Hangmok(sDate, sGubun : String; iYh : Integer): String;
begin
   Result := '';
