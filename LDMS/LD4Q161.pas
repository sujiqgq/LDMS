...
procedure TfrmLD4Q161.QuickRepNeedData(Sender: TObject;
...
begin
   ...
   begin
      ...
      QRLabel3.Caption  := Col[8].Heading;
      // 자료가 없을경우의 처리
      if Rows = 0 then
      begin
         MoreData := False;
      ...
      QRL_hm1.Caption       := Cell[ 8,UV_iCount];
...
procedure TfrmLD4Q161.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   inherited;
   QRL_date_start.Caption := copy(frmLD4Q16.mskDate_start.Text,1,4) + '년'  +
                             copy(frmLD4Q16.mskDate_Start.Text,5,2) + '월'  +
                             copy(frmLD4Q16.mskDate_Start.Text,7,2) + '일';
   UV_iCount := 0;
end;
