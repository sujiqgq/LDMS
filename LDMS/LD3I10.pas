...
// 수정자        : 곽윤설
// 수정내용      : 혈액결과 업로드...
// 참고사항      : 한의 재단진단검사의학팀1500972//2015.12 한달만 사용..
//==============================================================================
      ...
      try
         ...
         begin
              ...
              begin
                   ...
                   begin
                        if StrToFloat(Trim(TG_gumgin.Cells[10,I])) < 10.0 then sSuchi := '음성'
                        else if (StrToFloat(Trim(TG_gumgin.Cells[10,I])) >= 10.0) and
                                (StrToFloat(Trim(TG_gumgin.Cells[10,I])) <= 30.0) then sSuchi := '약양성'
                        else if StrToFloat(Trim(TG_gumgin.Cells[10,I])) > 30.0 then sSuchi := '양성';
