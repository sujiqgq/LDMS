...
type
  TfrmLD2Q12 = class(TfrmSingle)
    ...
    UV_vNo, UV_vName, UV_vJumin, UV_vBUN, UV_vSampNo, UV_vDanche, UV_vRack, UV_vS008, UV_vS091 : Variant;
...
var
  frmLD2Q12: TfrmLD2Q12;

implementation

uses ZZFunc, ZZMenu, ZZComm, MdmsFunc, LD2Q120, LD2Q121;

{$R *.DFM}

procedure TfrmLD2Q12.UP_KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmLD2Q12.MouseWheelHandler(var Message: TMessage);  //수정
begin
...
procedure TfrmLD2Q12.UP_VarMemSet(iLength : Integer);
begin
   ...
   begin
      ...
      UV_vDanche := VarArrayCreate([0, 0], varOleStr);
  end
   else
   begin
      // 이미 생성된 변수들의 크기를 조정
      ...
      VarArrayRedim(UV_vDanche, iLength);
   end;
end;

function TfrmLD2Q12.UF_Condition : Boolean;
begin
   Result := True;
...
procedure TfrmLD2Q12.FormCreate(Sender: TObject);
begin
   inherited;
   UP_VarMemSet(0);
...
procedure TfrmLD2Q12.grdMasterCellLoaded(Sender: TObject; DataCol,
  DataRow: Integer; var Value: Variant);
begin
   inherited;
   ...
   case DataCol of
      ...
      3 : Value := UV_vJisa[DataRow-1];
      4 : Value := UV_vBUN[DataRow-1];
      5 : Value := UV_vName[DataRow-1];
      6 : Value := UV_vJumin[DataRow-1];
      7 : Value := UV_vS008[DataRow-1];
      8 : Value := UV_vS091[DataRow-1];
      9 : Value := UV_vDanche[DataRow-1];
     10 : Value := UV_vSampNo[DataRow-1];
   end;
end;

procedure TfrmLD2Q12.btnQueryClick(Sender: TObject);
...
begin
   ...
   begin
      ...
      sSelect := ' SELECT G.Cod_jisa, G.desc_name, G.num_jumin, G.dat_gmgn, G.num_samp, B.desc_RackNo, G.gubn_nosin, G.gubn_adult, G.gubn_life,  ' +
                 '        G.Gubn_bogun, G.Gubn_agab, G.Gubn_tkgm, Gubn_nsyh, Gubn_adyh, Gubn_lfyh, Gubn_bgyh, Gubn_agyh, B.num_Bunju, D.desc_dc, ' +
      ...
      begin
         GP_query_log(qryBunju, 'LD2Q12', 'Q', 'N');
         ...
         Begin
            ...
            begin
               ...
               UV_vDanche[Index] := qryBunju.FieldByName('Desc_dc').AsString;
...
procedure TfrmLD2Q12.UP_Click(Sender: TObject);
...
procedure TfrmLD2Q12.btnPrintClick(Sender: TObject);
begin
  inherited;
  frmLD2Q120 := TfrmLD2Q120.Create(Self);
  if RBtn_preveiw.Checked then frmLD2Q120.QuickRep.Preview
  else                         frmLD2Q120.QuickRep.Print;
end;

procedure TfrmLD2Q12.FormActivate(Sender: TObject);
begin
   inherited;
   BunjuNo1.Text := '0001';
   BunjuNo2.Text := '9999';
...
procedure TfrmLD2Q12.Btn_NamePrintClick(Sender: TObject);
begin
   inherited;
   frmLD2Q121 := TfrmLD2Q121.Create(Self);
   if RBtn_preveiw.Checked then frmLD2Q121.QuickRep.Preview
   else                         frmLD2Q121.QuickRep.Print;
end;

function TfrmLD2Q12.UF_hangmokList : String;
var
...
function TfrmLD2Q12.UF_No_Hangmok(sDate, sGubun : String; iYh : Integer): String;
begin
   Result := '';
...
procedure TfrmLD2Q12.SBut_ExcelClick(Sender: TObject);
var
  XL,WorkBook: Variant;
  i : integer;
  ArrV3 : OleVariant;
