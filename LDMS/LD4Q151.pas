...
procedure TfrmLD4Q151.QuickRepNeedData(Sender: TObject;
...
procedure TfrmLD4Q151.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   inherited;
   QRL_date_start.Caption := copy(frmLD4Q15.mskDate_start.Text,1,4) + '년'  +
                             copy(frmLD4Q15.mskDate_Start.Text,5,2) + '월'  +
                             copy(frmLD4Q15.mskDate_Start.Text,7,2) + '일';
   UV_iCount := 0;
end;
