...
procedure TfrmLD4Q793.QuickRepNeedData(Sender: TObject;
...
begin
   ...
   begin
      ...
      if (length(Cell[4,(iRow * 25) + cRow]) > 9) then
      begin
        Qrl_006.Font.Size := 5;
...
//------------------------------------------------------------------------------
      ...
      if (length(Cell[4,(iRow * 25) + cRow + 25]) > 9) then
      begin
        Qrl_014.Font.Size := 5;
...
procedure TfrmLD4Q793.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   inherited;
