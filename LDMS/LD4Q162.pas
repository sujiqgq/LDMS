...
procedure TfrmLD4Q162.QuickRepNeedData(Sender: TObject;
...
begin
   ...
   begin
      ...
      repeat
         ...
         qryBunju.ParamByName('cod_bjjs').AsString   := copy(frmLD4Q16.cmbjisa.Text,1,2);
...
procedure TfrmLD4Q162.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   UV_iCount := 1;
   UV_iRow := 0;
