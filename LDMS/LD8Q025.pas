...
procedure TfrmLD8Q025.QuickRepNeedData(Sender: TObject;
...
begin
   ...
   begin
      ...
      if UV_iTemp = 0 then
      begin
         QRL_Hangmok.Caption := 'CRP정량[S071]';
...
procedure TfrmLD8Q025.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
var
   i : integer;
begin
   ...
   begin
      if (trim(frmLD8Q02.grdMaster.Cell[1,i]) = 'S071') then
      begin
         UV_iSpace := i;
