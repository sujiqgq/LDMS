...
type
  TfrmLD5Q061 = class(TfrmPrintForm)
    TitleBand1: TQRBand;
...
var
  frmLD5Q061: TfrmLD5Q061;

implementation

{$R *.DFM}

uses LD5Q06, ZZFunc, ZZMenu, ZZComm, MdmsFunc;

procedure TfrmLD5Q061.QuickRepNeedData(Sender: TObject;
  var MoreData: Boolean);
begin
   inherited;

   with frmLD5Q06.grdMaster do
   begin
      // 자료가 없을경우의 처리
      if Rows = 0 then
      begin
...
procedure TfrmLD5Q061.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   inherited;
