...
procedure TfrmLD2Q15.UP_VarMemSet_15(iLength : Integer);
begin
...
procedure TfrmLD2Q15.UP_VarMemSet(iLength : Integer);
begin
   // Variant Memory Allocation
   if iLength = 0 then
   begin
...
procedure TfrmLD2Q15.grdMaster_CellLoaded(Sender: TObject; DataCol,
  DataRow: Integer; var Value: Variant);
begin
   inherited;
...
procedure TfrmLD2Q15.FormCreate(Sender: TObject);
begin
   inherited;
   cmbPart.ItemIndex := 0;
...
procedure TfrmLD2Q15.UP_Click(Sender: TObject);
begin
   inherited;
...
procedure TfrmLD2Q15.UP_KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
   inherited;
...
procedure TfrmLD2Q15.btnPrintClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmLD2Q15.btnQueryClick(Sender: TObject);
Var
...
begin
   ...
   Begin
      ...
      begin
         ...
         while Not Eof Do
         begin
            If      FieldByName('Gubn_Part').AsString = '01' Then begin UV_vPart[Index] := '생화학';   UV_vJPart[Index] := '생화학';    end
            Else If FieldByname('Gubn_Part').AsString = '02' Then begin UV_vPart[Index] := '혈액학';   UV_vJPart[Index] := '혈액학';    end
            Else If FieldByname('Gubn_Part').AsString = '03' Then begin UV_vPart[Index] := 'URIN';     UV_vJPart[Index] := 'URIN';      end
            Else If FieldByname('Gubn_Part').AsString = '04' Then begin UV_vPart[Index] := 'RIA';      UV_vJPart[Index] := 'RIA';       end
            Else If FieldByname('Gubn_Part').AsString = '05' Then begin UV_vPart[Index] := 'EIA';      UV_vJPart[Index] := 'EIA';       end
            Else If FieldByname('Gubn_Part').AsString = '06' Then begin UV_vPart[Index] := '조직학';   UV_vJPart[Index] := '조직학';    end
            Else If FieldByname('Gubn_Part').AsString = '07' Then begin UV_vPart[Index] := '혈청학';   UV_vJPart[Index] := '혈청학';    end
            Else If FieldByname('Gubn_Part').AsString = '08' Then begin UV_vPart[Index] := '혈액기타'; UV_vJPart[Index] := '혈액기타';  end
            Else If FieldByname('Gubn_Part').AsString = '09' Then begin UV_vPart[Index] := '특검';     UV_vJPart[Index] := '특검';      end;
...
Function TfrmLD2Q15.HangmokFind( vTemp , vHangmok : String) : String;
var
...
procedure TfrmLD2Q15.UP_Insert(iTemp : Integer; sHangmok, sGubn_nosin, sGubn_adult, sGubn_life, sGubn_hulgum, sCod_Jisa : String);
begin
...
procedure TfrmLD2Q15.UP_Count(iRow : integer; sCod_jisa : string);
begin
...
procedure TfrmLD2Q15.SBut_ExcelClick(Sender: TObject);
var
  XL,WorkBook: Variant;
  i : integer;
  ArrV3 : OleVariant;
...
procedure TfrmLD2Q15.grdMaster_15CellLoaded(Sender: TObject; DataCol,
  DataRow: Integer; var Value: Variant);
begin
   inherited;
