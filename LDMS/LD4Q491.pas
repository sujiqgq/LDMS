...
var
  frmLD4Q491: TfrmLD4Q491;

implementation

uses ZZFunc, ZZMenu, ZZComm, MdmsFunc, LD4Q49;

{$R *.DFM}

procedure TfrmLD4Q491.QuickRepNeedData(Sender: TObject;
...
begin
   ...
   begin
      ...
      QRLabel_101.Caption:= frmLD4Q49.grdMaster.Col[5].heading;
      QRLabel_102.Caption:= frmLD4Q49.grdMaster.Col[6].heading;
      QRLabel_103.Caption:= frmLD4Q49.grdMaster.Col[7].heading;
      QRLabel_104.Caption:= frmLD4Q49.grdMaster.Col[8].heading;
      QRLabel_105.Caption:= frmLD4Q49.grdMaster.Col[9].heading;
      QRLabel_106.Caption:= frmLD4Q49.grdMaster.Col[10].heading;
      QRLabel_107.Caption:= frmLD4Q49.grdMaster.Col[11].heading;
      QRLabel_108.Caption:= frmLD4Q49.grdMaster.Col[12].heading;
      QRLabel_109.Caption:= frmLD4Q49.grdMaster.Col[13].heading;
      QRLabel_110.Caption:= frmLD4Q49.grdMaster.Col[14].heading;
      QRLabel_111.Caption:= frmLD4Q49.grdMaster.Col[15].heading;
      QRLabel_112.Caption:= frmLD4Q49.grdMaster.Col[16].heading;
      QRLabel_113.Caption:= frmLD4Q49.grdMaster.Col[17].heading;
      QRLabel_114.Caption:= frmLD4Q49.grdMaster.Col[18].heading;
      QRLabel_115.Caption:= frmLD4Q49.grdMaster.Col[19].heading;
      QRLabel_116.Caption:= frmLD4Q49.grdMaster.Col[20].heading;
      QRLabel_117.Caption:= frmLD4Q49.grdMaster.Col[21].heading;
...
procedure TfrmLD4Q491.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   inherited;
   QRL_date.Caption := copy(frmLD4Q49.edtBDate.Text,1,4) + '년'  +
                       copy(frmLD4Q49.edtBDate.Text,5,2) + '월'  +
                       copy(frmLD4Q49.edtBDate.Text,7,2) + '일';
   UV_iCount := 0;
end;
