...
var
  frmLD1P11: TfrmLD1P11;

implementation

uses ZZFunc, ZZMenu, ZZComm, MdmsFunc, LDAI01, LD1P121, LD1P122;

{$R *.DFM}

procedure TfrmLD1P11.UP_KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmLD1P11.UP_Change(Sender: TObject);
var sName : String;
begin
  inherited;
...
procedure TfrmLD1P11.UP_Click(Sender: TObject);
...
procedure TfrmLD1P11.btnPreviewClick(Sender: TObject);
begin
  inherited;
...
function  TfrmLD1P11.UF_Query : Boolean;
var sWhere : String;
begin
...
function TfrmLD1P11.UF_Condition : Boolean;
begin
   Result := True;
...
procedure TfrmLD1P11.FormCreate(Sender: TObject);
var  sJisa : string;
begin
  inherited;
...
procedure TfrmLD1P11.btnPrintClick(Sender: TObject);
begin
  inherited;
  if Chk_New.Checked = False then
  begin
...
procedure TfrmLD1P11.btnCloseClick(Sender: TObject);
begin
  inherited;
  close;
end;

procedure TfrmLD1P11.Ck_DoctorClick(Sender: TObject);
begin
  inherited;
...
function TfrmLD1P11.UF_Query2: Boolean;
var sWhere : String;
begin
