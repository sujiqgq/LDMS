...
procedure TfrmLD4Q322.QuickRepNeedData(Sender: TObject;
...
procedure TfrmLD4Q322.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   UV_iCount := 0;
end;
