...
procedure TfrmLD2Q103.QuickRepNeedData(Sender: TObject;
...
begin
   ...
   begin
      ...
      repeat
         ...
         qryBunju.ParamByName('cod_bjjs').AsString  := frmLD2Q10.UV_Bjjs;
         ...
         begin
            GP_query_log(qryBunju, 'LD2Q103', 'Q', 'Y');
...
procedure TfrmLD2Q103.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   UV_iCount := 1;
   //UV_iCount := 0;
