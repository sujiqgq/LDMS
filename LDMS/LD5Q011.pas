...
type
  TfrmLD5Q011 = class(TfrmPrintForm)
    TitleBand1: TQRBand;
...
procedure TfrmLD5Q011.QuickRepNeedData(Sender: TObject;
  var MoreData: Boolean);
begin
   inherited;

   with frmLD5Q01.grdMaster do
   begin
      // 자료가 없을경우의 처리
      if Rows = 0 then
      begin
...
procedure TfrmLD5Q011.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   inherited;
