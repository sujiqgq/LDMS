...
var
  frmLD5Q13: TfrmLD5Q13;

implementation

uses ZZFunc, ZZMenu, ZZComm, MdmsFunc, LD5Q131;

{$R *.DFM}

procedure TfrmLD5Q13.UP_KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmLD5Q13.MouseWheelHandler(var Message: TMessage);  //수정
begin
...
procedure TfrmLD5Q13.UP_VarMemSet(iLength : Integer);
begin
...
function TfrmLD5Q13.UF_Condition : Boolean;
begin
   Result := True;
...
procedure TfrmLD5Q13.FormCreate(Sender: TObject);
begin
   inherited;
   UP_VarMemSet(0);
...
procedure TfrmLD5Q13.grdMasterCellLoaded(Sender: TObject; DataCol,
  DataRow: Integer; var Value: Variant);
  var i :integer;
begin
   inherited;
...
procedure TfrmLD5Q13.btnQueryClick(Sender: TObject);
var index, I : integer;
...
begin
   ...
   begin
     ...
     // sOrderBy := ' ORDER BY B.Desc_Rackno ';
      ...
      begin
         GP_query_log(qryBunju, 'LD5Q13', 'Q', 'N');
...
procedure TfrmLD5Q13.UP_Click(Sender: TObject);
...
procedure TfrmLD5Q13.FormActivate(Sender: TObject);
begin
   inherited;
...
function TfrmLD5Q13.UF_hangmokList : String;
var
   i ,k, j : integer;
...
function TfrmLD5Q13.UF_No_Hangmok(sDate, sGubun : String; iYh : Integer): String;
begin
   Result := '';
...
procedure TfrmLD5Q13.btnPrintClick(Sender: TObject);
begin
  inherited;
  frmLD5Q131 := TfrmLD5Q131.Create(Self);
  if RBtn_preveiw.Checked = True then frmLD5Q131.QuickRep.Preview
  else                                frmLD5Q131.QuickRep.Print;
