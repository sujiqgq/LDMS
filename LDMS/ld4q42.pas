...
type
  ...
  private
    ...
    UV_vNo, UV_vSamp, UV_vBUN, UV_vT011, UV_vT007, UV_vSex, UV_vName  : Variant;
...
var
  frmLD4Q42: TfrmLD4Q42;

implementation

uses ZZFunc, ZZMenu, ZZComm, MdmsFunc, LD4Q421;

{$R *.DFM}

procedure TfrmLD4Q42.UP_KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmLD4Q42.MouseWheelHandler(var Message: TMessage);  //수정
begin
...
procedure TfrmLD4Q42.UP_VarMemSet(iLength : Integer);
begin
...
function TfrmLD4Q42.UF_Condition : Boolean;
begin
   Result := True;
...
procedure TfrmLD4Q42.FormCreate(Sender: TObject);
begin
   inherited;
   UP_VarMemSet(0);
...
procedure TfrmLD4Q42.grdMasterCellLoaded(Sender: TObject; DataCol,
  DataRow: Integer; var Value: Variant);
begin
   inherited;
   ...
   case DataCol of
      ...
      4 : Value := UV_vSex[DataRow-1];
      5 : Value := UV_vName[DataRow-1];
      6 : Value := UV_vT011[DataRow-1];
      7 : Value := UV_vT007[DataRow-1];
   end;
end;

procedure TfrmLD4Q42.btnQueryClick(Sender: TObject);
   ...
   begin
      ...
      begin
         ...
         Begin
            ...
            IF ((pos('T011',sHul_List) > 0) and (sMan <> 'M')) or ((pos('T007',sHul_List) > 0) and (sMan <> 'F'))   then
            begin
         ...
         // Table과 Disconnect
         Close;
         UV_vT011[Index]      :=   IntToStr(sum_PSA)   + '명';
         UV_vT007[Index]      :=   IntToStr(sum_CA125) + '명';
         Inc(index);
      end
      else
      begin
...
procedure TfrmLD4Q42.UP_Change(Sender: TObject);
var sName : String;
begin
  inherited;
...
procedure TfrmLD4Q42.UP_Click(Sender: TObject);
...
procedure TfrmLD4Q42.btnPrintClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmLD4Q42.FormActivate(Sender: TObject);
begin
   inherited;
   mskFrom.Text := '0001';
   mskTo.Text := '9999';
...
procedure TfrmLD4Q42.QRCompositeReportAddReports(Sender: TObject);
begin
  inherited;
  frmLD4Q421 := TfrmLD4Q421.Create(Self);

  with QRCompositeReport do
  begin
    Reports.Add(frmLD4Q421.QuickRep);
  end;
end;

function TfrmLD4Q42.UF_hangmokList : String;
var
...
function TfrmLD4Q42.UF_No_Hangmok(sDate, sGubun : String; iYh : Integer): String;
begin
   Result := '';
...
procedure TfrmLD4Q42.SBut_ExcelClick(Sender: TObject);
var
  XL,WorkBook: Variant;
  i : integer;
  ArrV3 : OleVariant;
