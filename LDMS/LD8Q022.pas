...
var
  frmLD8Q022: TfrmLD8Q022;

implementation

uses ZZFunc, ZZMenu, ZZComm, MdmsFunc, LD8Q02, LD8Q023, LD8Q024;

{$R *.DFM}

procedure TfrmLD8Q022.QuickRepNeedData(Sender: TObject;
...
procedure TfrmLD8Q022.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
var
   i : integer;
begin
   ...
   begin
      if (trim(frmLD8Q02.grdMaster.Cell[1,i]) = 'S003') then
      begin
         UV_iSpace := i;
