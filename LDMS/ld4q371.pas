...
begin
   ...
   begin
      ...
      if frmLD4Q37.btn_gmgn.checked then QRLabel5.Caption := '검진일자 :'
...
begin
   inherited;
   QRL_date.Caption := copy(frmLD4Q37.mskDate.Text,1,4) + '년'  +
                       copy(frmLD4Q37.mskDate.Text,5,2) + '월'  +
                       copy(frmLD4Q37.mskDate.Text,7,2) + '일';
   UV_iCount := 1;
