...
var
  frmLD4Q401: TfrmLD4Q401;

implementation

uses ZZFunc, ZZMenu, ZZComm, MdmsFunc, LD4Q40;

{$R *.DFM}

procedure TfrmLD4Q401.QuickRepNeedData(Sender: TObject;
...
begin
   ...
   begin
      ...
      begin
         ...
         QRL_Smaple.Caption  := Cell[2,  UV_iCount];
         QRL_Hangmok.Caption := Cell[3,  UV_iCount];
      end
      else
      begin
...
procedure TfrmLD4Q401.QuickRepBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
   inherited;
   QRL_date.Caption := '※ 분주일자 : ' +
                       copy(frmLD4Q40.msk_Bgmgn.Text,1,4) + '-'  +
                       copy(frmLD4Q40.msk_Bgmgn.Text,5,2) + '-'  +
                       copy(frmLD4Q40.msk_Bgmgn.Text,7,2);;
   UV_iCount  := 1;
   UV_Cnt     := 0;
end;

procedure TfrmLD4Q401.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var
    vCount :Integer;
begin
