...
procedure TfrmLD1P111.UP_FieldClear(frm : TWinControl);
var i : Integer;
begin
...
procedure TfrmLD1P111.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
