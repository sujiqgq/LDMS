...
begin
   ...
   if ((sHangmok = 'C009') or (sHangmok = 'C010') or (sHangmok = 'C011') or (sHangmok = 'C025') or (sHangmok = 'C026') or
       (sHangmok = 'C027') or (sHangmok = 'C028') or (sHangmok = 'C032') or (sHangmok = 'C042') or (sHangmok = 'C074') or (sHangmok = 'C033')) and
      (QryGumgin.FieldByName('cod_jisa').AsString <> '15') and (sGubn_hulgum = '3') then
   begin
     { if ((copy(QryGumgin.FieldByName('cod_jangbi').AsString, 1, 2) = 'SS') or (copy(QryGumgin.FieldByName('cod_jangbi').AsString, 1, 2) = 'SG')) then
      begin
           if ((QryGumgin.FieldByName('gubn_nosin').AsString) = '1') or ((QryGumgin.FieldByName('gubn_nosin').AsString) = '2') or
              ...
              ((QryGumgin.FieldByName('gubn_adult').AsString) = '1') or ((QryGumgin.FieldByName('gubn_adult').AsString) = '2') then
              begin
           ...
           begin
                if      sCod_jisa = '43' Then Uv_v43[iTemp] := Uv_v43[iTemp] + 0
                else if sCod_jisa = '12' Then Uv_v12[iTemp] := Uv_v12[iTemp] + 0
                else if sCod_jisa = '11' Then Uv_v11[iTemp] := Uv_v11[iTemp] + 0
                else if sCod_jisa = '71' Then Uv_v71[iTemp] := Uv_v71[iTemp] + 0
                else if sCod_jisa = '61' Then Uv_v61[iTemp] := Uv_v61[iTemp] + 0
                else if sCod_jisa = '51' Then Uv_v51[iTemp] := Uv_v51[iTemp] + 0;
           end;
      end
      else
      begin}
